<?
    ...
    if ($booking_view['airport_meeting_flag'] == 'Y') {
        $airport_meeting .= iif($booking_view['airport_meeting'] == 'Y', 'Yes', 'No');
    } else {
        $airport_meeting .= 'No';
    }
    if ($airport_meeting!='') {
    ...
    */
    ...
    //괌발송
    sendEmail($subject, "sj.yoon@raonworks.co.kr", "", SITE_EMAIL, SITE_NAME, $content);
?>
